...
selecaoCorBasica db "Informe uma das componentes basicas da imagem a ser alterada. Digite 0 para alterar a componente azul, digite 1 para alterar a componente verde ou 2 para alterar a componente vermelha: ", 0H
newLine db 0AH
...
intensidadeDaCor dd 0
componenteBasica dd 0
...
invoke WriteConsole, outputHandle, addr aumentoIntensidade, sizeof aumentoIntensidade, addr console_count, NULL
invoke ReadConsole, inputHandle, addr intensidadeDaCor, sizeof intensidadeDaCor, addr console_count, NULL  

 mov esi, offset intensidadeDaCor
 proximo3:
  mov al, [esi]
  inc esi
  cmp al, 13
...
invoke WriteConsole, outputHandle, addr selecaoCorBasica, sizeof selecaoCorBasica, addr console_count, NULL
invoke ReadConsole, inputHandle, addr componenteBasica, sizeof componenteBasica, addr console_count, NULL

mov esi, offset componenteBasica
 proximo4:
  mov al, [esi]
  inc esi
  cmp al, 13
